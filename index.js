...
function hub() {
    Swal.fire({
		...
		<button style="background-color:#CA185D" class="swal2-styled swal2-default-outline" onclick="changerURLOut('https://www.hatier-clic.fr/2959162')"><h1>Anglais - Ressources</h1></button>
        `,
        icon: "question",
